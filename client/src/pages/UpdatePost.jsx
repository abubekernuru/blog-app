    ...
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        ...
        <TextInput type='text' placeholder='Title' id='title' onChange={(e)=>handleChange(e)} required className='flex-1'
          ...
          />
          <Select id='category' required className='w-48' onChange={(e)=>handleChange(e)} value={formData.category}>
        ...
        <ReactQuill onChange={(value)=>setFormData((prev)=>({...prev, content: value}))} id='content' theme="snow" placeholder='Write your post content here...' className='h-72 mb-12'value={formData.content}/>
